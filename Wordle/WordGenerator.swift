...
class WordGenerator {
  ...
  // Checkpoint: After finishing this exercise, yapou should now have a different goal word each time you run the app! Try printing out the selected goal word to check. If it's not working, check that you have done this exercise correctly.
  static let possibleWords = ["APPLE", "BRAVE", "CHIME", "DELTA", "EAGER"]
